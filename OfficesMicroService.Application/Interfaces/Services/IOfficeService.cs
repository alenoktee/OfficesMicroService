...
public interface IOfficeService
{
    ...
    Task<OfficeDto> GetByIdAsync(string id, CancellationToken cancellationToken = default);
    Task<OfficeDto> CreateAsync(OfficeCreateDto officeCreateDto, CancellationToken cancellationToken = default);
    Task UpdateAsync(string id, OfficeUpdateDto officeUpdateDto, CancellationToken cancellationToken = default);
